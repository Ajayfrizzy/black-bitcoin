...
const Howto = () => {
  return (
    <div className="max-w-7xl mx-auto mt-12 text-center text-white flex flex-col items-center py-[4rem] px-4">
      ...
      <div className="bg-[#444444] relative rounded-lg h-[50vh] md:h-[50vh] p-[3rem] md:p-[5rem] flex flex-col md:flex-row items-center justify-between shadow-lg">
        ...
        <div className="bg-[#444444] relative rounded-lg h-[50vh] md:h-[50vh] p-[3rem] md:p-[5rem] flex flex-col md:flex-row items-center justify-between shadow-lg">
          <div className="flex flex-col md:space-y-4">
            <div className="flex md:flex-col gap-5">
              ...
              <span className="font-medium">Swap to BlackBitcoin</span>
            </div>
