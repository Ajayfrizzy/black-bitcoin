...
const Tokenomics = () => {
  return (
    ...
    <div className="max-w-7xl mx-auto text-center my-[3rem]">
      <h2 className="geist font-bold text-[2.5rem]">BlackBitcoin Tokenomics</h2>
      <div className="flex justify-center items-center mt-[4rem] mb-[3rem] space-grotesk">
        <div>
          <Image src="/asset/pie_chart.svg" alt="pie chart" width={351} height={341} />
        </div>
        <div className="text-left ml-[4rem]">
          <ul>
